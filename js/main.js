...
d3.csv("data/iris.csv").then((data) => {
    ...
    FRAME1.selectAll("points")
        ...
        .append("circle")
            ...
            .attr("cx", (d) => { return (parseFloat(d.Sepal_Length) * 50) + MARGINS.left; })
            // calculations for y: increases scale, considers our perception of x/y plane, margins
            .attr("cy", (d) => { return ((8 - parseFloat(d.Petal_Length)) * 50) + MARGINS.top; })
    ...
    .attr("transform", "translate(" + MARGINS.left +
    "," + MARGINS.top + ")")
    .call(d3.axisLeft(Y_AXIS_SCALE).ticks(8))
    .attr("font-size", "10px");
